...
<tr><td style="background-color:{DARK};padding:0;">
  ...
  <tr><td style="padding:28px 40px 24px 40px;">
    ...
    <tr>
      <td valign="bottom">
        <p style="margin:0 0 2px 0;font-family:{SANS};font-size:10px;letter-spacing:4px;text-transform:uppercase;color:{GOLD};font-weight:600;">China Tech Intelligence</p>
        <p style="margin:0;font-family:{SERIF};font-size:32px;font-weight:700;color:#ffffff;line-height:1.1;letter-spacing:-0.5px;">China KI-Briefing</p>
      </td>
...
def _build_preheader(sections):
    ...
    return " · ".join(themes) if themes else "China KI-Briefing"
